<section>
<h2 class="card border-0 border-bottom pt-3 mb-3 text-center">All Blogs</h2>
                        ...
                        foreach ($data['blog_info'] as &$entry) : 
                            ...
                            echo '<article class="card m-5">';
                                ...
                                echo '<div class="card-body">';
                                    ...
                                    echo '<a href="' . parse_url($_SERVER['REQUEST_URI'])['path']. "/" . $entry->getField('id')->getValue() . '" class="btn btn-primary">Read More</a>';
                                echo '</div>';
                            echo '</article>';
                        // End of the loop
                        endforeach; 
